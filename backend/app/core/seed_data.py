...
_PROBLEM_DEFS = [
    ...
    },
    {
        ...
        "stones": {(2, 6): "B", (4, 6): "B", (3, 5): "B", (3, 6): "W", (2, 5): "W", (4, 5): "W"},
        "correct": (3, 7), "player": "B",
        "explanation": "黑下 D2 提掉白棋 D3。提子后白若立即在 D3 回提黑 D2，局面将回到提子前——围棋规则禁止全局同形再现，所以白必须先找劫材才能回提。这就是打劫。",
        "distractors": [(0, 0)],
    },
    {
...
_COURSE_DEFS = [
    {
        ...
        "lessons": [
            ...
            {"title": "打劫与禁入点", "steps": [
                {"instruction": "打劫：双方可以反复互提一子的特殊形状，规则禁止立即回提。", "sgf": build_sgf({(2, 6): "B", (4, 6): "B", (3, 5): "B", (3, 6): "W", (2, 5): "W", (4, 5): "W"}, 9), "explanation": "黑下 D2 提白 D3 后形成劫。白若立即回提 D3，局面回到提子前——禁止同形再现，所以白必须先找劫材。"},
            ]},
        ],
    },
    {
